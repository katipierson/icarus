...
#### Packs
* Homestead Content Pack
* Pet Companions Pack
* Creature Comforts Pack
* Art Deco Furniture Pack
* Industrial Furniture Pack
* Interior Decorations Pack

#### Outposts
* Frostfall Outpost
* Aquatica Isle Outpost
* Arcticus Outpost
* Everbark Outpost
* Tecton Outpost
* Cactus Outpost
...
## Wie installiere ich dieses Profil?

* Auf Windows gehst Du in den Ordner: C:/Users/{Benutzername}/AppData/Local/Icarus/Saved/PlayerData/{eine lange Nummer}/
* Enweder löschst Du Dein Profil (vorsicht Du verlierst deine Charaktere) oder Du öffnest die Datei "profile.json"

* gelöschtes Profil
  * starte Icarus neu
  * lege einen Charakter an
  * beende Icarus
  * überschreibe die Datei "profile.json" und setze deine UserID in die erste Zeile ein.

* "profil.json" ändern
  * kopiere alles bis auf "UserID": "76561198254483787", "NextChrSlot": 1, 	"DataVersion": 4 - also die erste und zweite Zeile und die letzte, vorletzte und die vorvorletzte in Deine "profile.json"
